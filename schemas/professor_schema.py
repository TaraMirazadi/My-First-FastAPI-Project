...
class ProfessorCreate(BaseModel):
    ...
    first_name: str = Field(..., min_length=2, max_length=50, examples=["Mahdi"])
    last_name: str = Field(..., min_length=2, max_length=50, examples=["Azadi"])
    personal_code: str = Field(..., min_length=3, max_length=20, examples=["401071"])
